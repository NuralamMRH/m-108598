...
import { Bath, Dumbbell, Waves as WavesIcon, Users, Utensils, Wine, Coffee, Clock, Car, Plane, MapPin, Waves, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Bath key={0} />, <Dumbbell key={1} />, <WavesIcon key={2} />, <Users key={3} />],
